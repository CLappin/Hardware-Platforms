...
A zipped file of the PolarFire Evaluation Kit repository is available [here](https://github.com/RISCV-on-Microsemi-FPGA/PolarFire-Eval-Kit/archive/master.zip)

Or the repository can be checkout using the following commands:
